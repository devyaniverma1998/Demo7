                        ...
                        <div className="row">
                                ...
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-1.jpg" alt="not found" />
                                        </a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-2.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-3.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-4.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-5.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-6.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-7.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-8.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                            ...
                            <div className="col-md-4">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-9.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
                        ...
                        <div className="sidebar-widget widget-slider">
                            <div className="sidebar-slider normal-slider">
                                <div className="product-item">
                                    ...
                                    <div className="product-image">
                                        <a href="product-detail.html">
                                            <img src="img/product-10.jpg" alt="not found" />
                                        </a>
                                        <div className="product-action">
                                            <a href="/"><i className="fa fa-cart-plus"></i></a>
                                            <a href="/"><i className="fa fa-heart"></i></a>
